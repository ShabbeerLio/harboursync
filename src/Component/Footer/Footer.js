      ...
      <div className="Footer">
        <div className="Footer-main">
          <div className="footer-detail-box">
            ...
            <div className="footer-right-quick">
              ...
              <ul>
                <li>
                  <Link to="mailto: harboursyncexpimp@gmail.com">
                    harboursyncexpimp@gmail.com
                  </Link>
                </li>
              </ul>
              <p>
                WARD NO-06 , GANESHPUR TINPULIYA , P.S BYPASS JAGDISHPUR KHIRIBANDHA
                BHAGALPUR-812005 BIHAR , INDIA
              </p>
            </div>
        ...
        <div className="footer-down">
          <div className="footer-copyright">
            <p>
              © 2024 HARBOURSYNC EXPIMP PRIVATE LIMITED | All rights reserved
            </p>
          </div>
        </div>
      </div>
